...
description: This policy refers to the Server Security High-Level Guidelines for Redback Operations.
---
<div style={{ width: '100%' }}>
...
- [Scope](#scope)
  ...
  - [Key Assets and Data Categories](#key-assets-and-data-categories)
  - [Framework References](#framework-references)
    - [ISO 27001:2022 Controls:](#iso-270012022-controls)
...
- [Roles and Responsibilities](#roles-and-responsibilities)
  ...
  - [RACI Chart](#raci-chart)
    - [Legend:](#legend)
- [Strategic Overview \& Controls](#strategic-overview--controls)
  - [Operating System Hardening](#operating-system-hardening)
    - [Operating System Selection](#operating-system-selection)
    - [Operating System Releases and Versions](#operating-system-releases-and-versions)
    - [Standard Operating Environments (SOEs)](#standard-operating-environments-soes)
    - [Hardening Operating System Configurations](#hardening-operating-system-configurations)
    - [OS Security Protections](#os-security-protections)
    - [Control References](#control-references)
  - [Application Management and Control](#application-management-and-control)
    - [Application Management](#application-management)
    - [Application Control](#application-control)
    - [Command Shell](#command-shell)
    - [PowerShell](#powershell)
    - [Control References](#control-references-1)
  - [Intrusion Prevention, Software Firewalls, Antivirus, and Device Access Control](#intrusion-prevention-software-firewalls-antivirus-and-device-access-control)
    - [Host-Based Intrusion Prevention System (HIPS)](#host-based-intrusion-prevention-system-hips)
    - [Software Firewall](#software-firewall)
    - [Antivirus Software](#antivirus-software)
    - [Device Access Control Software](#device-access-control-software)
    - [Control References](#control-references-2)
  ...
  - [User Application Hardening](#user-application-hardening)
    ...
    - [User Application Selection](#user-application-selection)
    - [User Application Releases](#user-application-releases)
    - [Hardening User Application Configurations](#hardening-user-application-configurations)
    - [Control References:](#control-references-3)
  - [Microsoft Office Macros](#microsoft-office-macros)
    - [Control References](#control-references-4)
  - [Server Application Hardening](#server-application-hardening)
    - [Server Applications](#server-applications)
    - [Server Application Selection](#server-application-selection)
    - [Server Application Releases](#server-application-releases)
    - [Hardening Server Application Configurations](#hardening-server-application-configurations)
    - [Restricting Privileges for Server Applications](#restricting-privileges-for-server-applications)
    - [Control References](#control-references-5)
  - [Microsoft Active Directory Domain Services (AD DS) Hardening](#microsoft-active-directory-domain-services-ad-ds-hardening)
    - [Microsoft AD DS Account Hardening](#microsoft-ad-ds-account-hardening)
  - [Microsoft AD DS Security Group Memberships](#microsoft-ad-ds-security-group-memberships)
    - [Control References](#control-references-6)
  - [Authentication Hardening](#authentication-hardening)
    - [Account and Authentication Types](#account-and-authentication-types)
    - [Authenticating to Systems](#authenticating-to-systems)
    - [Insecure Authentication Methods](#insecure-authentication-methods)
    ...
    - [Setting Credentials for Break Glass, Local Administrator, and Service Accounts](#setting-credentials-for-break-glass-local-administrator-and-service-accounts)
    ...
    - [Control Reference:](#control-reference-1)
  - [Virtualization Hardening](#virtualization-hardening)
    - [Hypervisors](#hypervisors)
    - [Containerization](#containerization)
    - [Functional Separation Between Computing Environments](#functional-separation-between-computing-environments)
    - [Control References:](#control-references-7)
- [Policy Review](#policy-review)
  - [Responsibility for Reviews](#responsibility-for-reviews)
  - [Frequency of Reviews](#frequency-of-reviews)
  - [Proposing and Approving Changes](#proposing-and-approving-changes)
  - [Communication Plan for Updates](#communication-plan-for-updates)
- [Appendix](#appendix)
