...
description: This policy refers to the Monitoring & Log Analytics High-Level Guidelines for Redback Operations.
---
...
- [Scope](#scope)
  ...
  - [RACI Chart](#raci-chart)
    - [Legend](#legend)
  - [Types of Digital Assets Covered Under the Log Analytics Policy](#types-of-digital-assets-covered-under-the-log-analytics-policy)
    - [Web-facing Applications and Services](#web-facing-applications-and-services)
    - [Network Infrastructure](#network-infrastructure)
    - [Cloud Services and Infrastructure](#cloud-services-and-infrastructure)
    - [Email and Communication Servers](#email-and-communication-servers)
    - [Remote Access Services](#remote-access-services)
    - [IT Assets](#it-assets)
- [Monitoring \& Log Analytics Lifecycle](#monitoring--log-analytics-lifecycle)
- [Log Collection Management, Practices \& Activities](#log-collection-management-practices--activities)
  - [Data \& Log Types](#data--log-types)
    - [User Access and Authentication Logs](#user-access-and-authentication-logs)
    - [System and Application Changes](#system-and-application-changes)
    - [Network Activity Logs](#network-activity-logs)
    - [Data Access and Usage Logs](#data-access-and-usage-logs)
  - [Log Formats](#log-formats)
    - [Standardized Formats](#standardized-formats)
    - [Detailed Elements](#detailed-elements)
    - [Encryption and Secure Streaming](#encryption-and-secure-streaming)
  - [Security Operations Centre (SOC) Activities](#security-operations-centre-soc-activities)
    - [Real-time Monitoring and Analysis](#real-time-monitoring-and-analysis)
  - [Log Collection Frequency \& Retention](#log-collection-frequency--retention)
    - [Log Collection Standards](#log-collection-standards)
    - [Retention Duration](#retention-duration)
    - [Secure Storage and Destruction](#secure-storage-and-destruction)
  - [Compliance with Standards \& Controls](#compliance-with-standards--controls)
  - [Auditing \& Review](#auditing--review)
  - [Documentation and Training](#documentation-and-training)
  - [SIEM/SOC Logging Protection](#siemsoc-logging-protection)
