...
| Encoding Normalization | Normalize inputs to avoid evasions. | Decode inputs before validation.  <br><br/>from unicodedata import normalize<br><br>| Bypass filters | A.14.2.5 |
